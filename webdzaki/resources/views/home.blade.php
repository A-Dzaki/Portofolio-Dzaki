        ...
        <div class="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-12 items-center w-full">
            <div>
                ...
                <p class="hero-text text-slate-400 leading-relaxed text-base md:text-lg mb-8">
                    Saya adalah mahasiswa semester 6 yang memiliki ketertarikan pada bidang web development.Saya fokus
    ...
    <section class="w-full min-h-screen bg-slate-900 text-white px-4 md:px-16 py-20" id="about">
        <div class="max-w-6xl mx-auto">
            ...
            <p class="text-slate-300 leading-relaxed text-lg md:text-xl mb-8 text-justify">
                Saya adalah mahasiswa semester 6 yang memiliki ketertarikan pada bidang web development, khususnya dalam
                ...
                akademik dan proyek yangpernah saya kerjakan, saya terus berusaha memahami proses pengembangan sistem
                secara lebih nyata. Saya
                juga terbuka untuk belajar dari lingkungan kerja profesional agar dapat meningkatkan kemampuan teknis,
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                ...
                <div
                    ...
                    <div
                        ...
                        <img src="{{ asset('assets/Travel.png') }}" alt="TravelJi" class="w-full h-full object-cover">
                    </div>
                    <div class="p-6">
                        <h3 class="text-2xl font-bold mb-2 text-blue-400">TravelJi Landing Page</h3>
                        <p class="text-slate-400 text-sm mb-4">Website landing page agen pariwisata menampilkan paket
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 justify-items-center">
                ...
                <a href="https://github.com/A-Dzaki" target="_blank"
                    ...
                    <div class="w-20 h-20 bg-white rounded-2xl flex items-center justify-center shadow-lg">
                        <img src="{{ asset('assets/github.png') }}" alt="GitHub Icon" class="w-10 h-10 object-contain">
                    </div>
